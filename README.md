...
- **裁剪功能不能100%保证成功。如果你勾选了智能裁剪，你要确保你的logo中的文字素材不是编组状态（如果你添加了文字素材的话）。这里的文字素材是指在高级编辑页面从右边文本——书法字、标题、列表内容等添加的组件。你可以单击这些文字素材，然后点击左上角弹出的取消编组按钮，使得组件取消编组。如果你勾选了智能裁剪但是有的文字素材没有取消编组的话，插件会提示你检查是否有未取消编组的文字素材**。
- V3.2.0新功能：
