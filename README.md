...
- **裁剪功能是根据代码结构规律做的，可能在设计logo的时候有些组件的代码结构没考虑到，所以导出的logo可能不符合预期，如果出现这种情况，请关闭裁剪功能，自己裁剪。可以的话请在github/gitee上面提个issue或者直接联系我反馈此问题~**
...
如果你希望增加标小智和未登录状态下的标智客的LOGO的智能裁剪功能，**请提issue或者在b站等平台私戳我**，我会视情况更新。
