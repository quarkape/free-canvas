...
### :game_die: V3.0.0正在开发，你的star和fork是我坚持的动力！！GitHub主页还有很多其他有趣的项目，欢迎关注~~

- 预计V3.0.0将有以下更新：

1. 支持标智客登录后编辑的LOGO下载（标智客登陆后可以使用高级LOGO编辑功能，可以自己添加组件等）
2. 智能导出正方形LOGO，免去再次裁剪过程
3. 自动判断页面类型，调整插件界面，界面更简洁
4. 优化代码逻辑
...
**tips：如果点击开始处理报错“undefined”，把logo设计网站都关了，再重新打开以下就可以了~
